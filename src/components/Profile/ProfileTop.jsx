  ...
  return (
    <div className="mt-3 mb-6 relative bg-white rounded-xl">
      ...
      <div className='flex flex-col sm:flex-row justify-between items-end -translate-y-16 w-full'>
        ...
        <div className=' mr-4'>
          <button className='text-white bg-[#F85F35] border border-[#F85F35] hover:bg-[#f85f35c8] transition-all rounded-lg flex gap-1 py-[10px] px-4 items-center'><img src={EditIcon} /> Edit Profile</button>
        </div>
      </div>
    </div>
  )
